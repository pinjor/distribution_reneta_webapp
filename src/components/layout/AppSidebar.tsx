...
const menuItems = [
  ...
  },
  {
    ...
    icon: Fuel,
    subItems: [
      { title: "Vehicles", icon: Car, path: "/transport/vehicles" },
      { title: "Drivers", icon: Users, path: "/transport/drivers" },
      { title: "Trip Assignment", icon: Route, path: "/transport/trips" },
      { title: "Expenses", icon: Receipt, path: "/transport/expenses" },
      { title: "Reports & Analytics", icon: TrendingUp, path: "/transport/reports" },
    ],
  },
  {
    title: "Billing",
  ...
  },
  {
    ...
    subItems: [
      ...
      { title: "Route Shipping Points", icon: Route, path: "/settings/route-shipping-points" },
      ...
      { title: "Chemist Shop", icon: Store, path: "/settings/chemist-shop" },
      { title: "Doctor", icon: Stethoscope, path: "/settings/doctor" },
